...
{
	public partial class FacebookOAuth2WWWApp127001 : Xamarin.Auth._MobileServices.Helpers.OAuth2
	{
		partial void SetPublicNonSensitiveData();
		partial void SetPrivateSensitiveData();

		public FacebookOAuth2WWWApp127001()
		{
		...
		partial void SetPublicNonSensitiveData()
		{
			Description = "Facebook OAuth2 WWW App Type Callbackurl http[s]://127.0.0.1/";
			OAuth_IdApplication_IdAPI_KeyAPI_IdClient_IdCustomer = "";
			OAuth2_Scope = ""; // "", "basic", "email",
			OAuth_UriAuthorization = new Uri("https://m.facebook.com/dialog/oauth/");
			OAuth_UriCallbackAKARedirect = new Uri("http://127.0.0.1/");
			AllowCancel = true;
            HowToMarkDown =
@"
	https://developers.facebook.com/apps/
		Settings 
            Display Name = Xamarin.Auth._MobileServices.WWW.ip
			Advanced
