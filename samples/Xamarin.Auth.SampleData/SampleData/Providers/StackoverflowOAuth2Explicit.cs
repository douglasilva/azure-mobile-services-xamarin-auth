...
{
	public partial class StackoverflowOAuth2Explicit : Xamarin.Auth._MobileServices.Helpers.OAuth2
	{
		partial void SetPublicNonSensitiveData();
		partial void SetPrivateSensitiveData();

		public StackoverflowOAuth2Explicit()
		{
...
";
			...
			OAuth_UriAccessToken_UriRequestToken = new Uri("https://stackexchange.com/oauth/access_token");
			AllowCancel = true;
