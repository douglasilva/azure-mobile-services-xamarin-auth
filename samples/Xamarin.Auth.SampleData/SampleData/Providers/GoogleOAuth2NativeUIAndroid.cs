...
{
    public partial class GoogleOAuth2NativeUIAndroid : Xamarin.Auth._MobileServices.Helpers.OAuth2
    {
        partial void SetPublicNonSensitiveData();
        partial void SetPrivateSensitiveData();

        public GoogleOAuth2NativeUIAndroid()
        {
            ...
            OAuth_UriCallbackAKARedirect =
                new Uri
                    (
                        ...
                        // $"http://xamarin.com"	
                        $"com.xamarin.traditional.standard.samples.oauth.providers.android:{OAuth_UriCallbackAKARedirectPath}"
